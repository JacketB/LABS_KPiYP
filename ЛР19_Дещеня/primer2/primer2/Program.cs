 ...
 ThreadStart[] threadsstart;
        ...
        ProgressBarDance()
        {
            ...
            for (int i = 0; i < ThreadsCount; i++)
            {
                ...
                pr[i].ClientSize = new
               Size(this.ClientRectangle.Width - 20, 50);
                ...
                bRun[i] = new CheckBox();
                bRun[i].Parent = this;
                bRun[i].Location = new Point(10, 10 + i * 100 +
               65);
                ...
                bSuspend[i].Location = new Point(170, 10 + i *
               100 + 65);
            ...
            bSuspend[i].Enabled = false;
                ...
                bRun[i].Click += new
               EventHandler(OnCheckBoxClick);
                bSuspend[i].Click += new
               EventHandler(OnCheckBoxClick);
            }
        }
        // Потоковая функция
        ...
        private void OnCheckBoxClick(object sender, EventArgs e)
        {
            ...
            int sindex = Array.IndexOf(bSuspend, check);
                ...
                if (check.Checked == true)
                {
                    ...
                    bSuspend[sindex].Text =
                   string.Format("Возобновить {0}-й поток", sindex + 1);
                }
                else
                {
                    ...
                    bSuspend[sindex].Text =
                   string.Format("Приостановить {0}-й поток", sindex + 1);
                }
            }
        }
